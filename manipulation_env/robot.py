...
class RobotBase(object):
    ...
    def __init__(self, model_path, pos=[0, 0, 0], ori=[0,0,0]):
        """
        Arguments:
            pos: [x y z]
            ori: [r p y]
...
class UR5Robotiq85(RobotBase):
    def __init_robot__(self):
        ...
        self.id = p.loadURDF(self.model_path, self.base_pos, self.base_ori,
...
class UR10Robotiq85(UR5Robotiq85):
    def __init_robot__(self):
        """
        model_path = '/models/urdf/ur10_robotiq_85.urdf'
        """
        # get the finger tips id
        self.finger_tip_ids_a = 9
        self.finger_tip_ids_b = 11
    ...
    def get_gripper_width(self):
        # get the gripper width from open angle
